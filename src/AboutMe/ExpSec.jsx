...
<div className='flex gap-6'>
    ...
    <img className='h-52 w-36 object-cover rounded-md' src="https://images.unsplash.com/photo-1736192252876-e086cd9fa39b?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
...
<div>
    ...
    <h1>A UI Developer (User Interface Developer) is responsible for creating the visual aspects of a website or application that users interact with. Their primary focus is on building clean, responsive, and visually appealing interfaces using HTML, CSS, JavaScript, and various front-end frameworks. UI developers work closely with UX designers to ensure that the design</h1>
</div>
...
<div className='flex gap-6'>
    ...
    <img className='h-52 w-36 object-cover' src="https://images.unsplash.com/photo-1736192252876-e086cd9fa39b?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
