    ...
    <div className="grid grid-cols-1 md:grid-cols-2  pt-28 container mx-auto md:px-28 ">
      <div>
        <div className="flex flex-col items-center md:items-start">
          ...
          <h6 className="mt-6 w-5/6 font-medium text-slate-500 text-center md:text-start">
      ...
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          <img
            className="absolute h-auto w-auto top-60 left-[-100px]"
            src="asset/blo1.png"
            alt=""
          />
        </div>
