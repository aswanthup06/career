...
export default function About() {
  return (
    <div className="">
      ...
      <div className="container grid gap-8 grid-cols-1 md:grid-cols-[1fr_2fr] py-10 md:py-20">
        <div className=" flex items-center flex-col">
          ...
          <h6 className="mt-6 w-5/6 font-medium text-slate-500 text-center">
            ...
            look and feel of digital applications, ensuring they are both
        ...
        <div className="flex items-center">
          <div className=" ">
            <h1 className="text-indigo-600 font-bold mb-1 md:mb-3 text-center md:text-start">
              UI/UX Developer
            </h1>
            <h1 className="text-2xl   md:text-3xl lg:text-4xl text-center md:text-start">
              I’m Aswanth UP, a UI Designer and Developer creating seamless
              digital experiences with precision and creativity
            </h1>

            <div className="flex items-center md:items-start flex-col md:flex-row gap-6 py-8">
            ...
            <div className="flex justify-center md:justify-start gap-6">
              <button className="text-xs md:text-sm bg-indigo-700 hover:bg-indigo-800 py-3 px-5 rounded-lg flex items-center gap-3">
                Download CV <HiOutlineDownload />
              </button>
              <a
                href="/about"
                className="text-xs md:text-sm bg-indigo-300 bg-opacity-5 hover:bg-opacity-10 py-3 px-5 rounded-lg duration-500"
              >
